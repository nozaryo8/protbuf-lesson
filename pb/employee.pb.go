...
type Employee struct {
	...
	PhoneNumber []string                    `protobuf:"bytes,5,rep,name=phone_number,json=phoneNumber,proto3" json:"phone_number,omitempty"`                                                              // reoeatedフィールド 複数の値をセットできる？
	Project     map[string]*Company_Project `protobuf:"bytes,6,rep,name=project,proto3" json:"project,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // マップ型 repeatedを付けることができない
